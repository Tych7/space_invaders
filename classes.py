	...
	def draw(self, win, image):
		if self.y < (1080 * self.ratio):
			...
			if self.visible == True:
				...
				pygame.draw.rect(win, (255,0,0), (self.hitbox[0] , (self.hitbox[1] - 8 * self.ratio) , 55 * self.ratio, 5))
				pygame.draw.rect(win, (0,128,0), (self.hitbox[0] , (self.hitbox[1] - 8 * self.ratio) , (55 * self.ratio) - (55 * (0 - self.health)), 5))
