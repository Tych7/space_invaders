...
class level_3:
    ...
    def init_objects(self):
        ...
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[1],self.ratio * self.alien_rows[2], self.ratio, 2))
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[3],self.ratio * self.alien_rows[2], self.ratio, 2))

        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[0],self.ratio * self.alien_rows[4], self.ratio, 2))
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[1],self.ratio * self.alien_rows[4], self.ratio, 2))
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[2],self.ratio * self.alien_rows[4], self.ratio, 2))
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[3],self.ratio * self.alien_rows[4], self.ratio, 2))
        self.alien_1_objects.append(alien_1(self.ratio * self.alien_collums[4],self.ratio * self.alien_rows[4], self.ratio, 2))
