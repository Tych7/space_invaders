...
def restart():
	...
	lvl =  pygame.image.load('lvl4.png').convert_alpha()
...
#mainloop
	...
	while True:
		...
		if not alienA.visible and not alienB.visible and not alienC.visible and not alienD.visible and not alienE.visible and not alienF.visible and not alienG.visible and not alienH.visible and not alienI.visible and not alienJ.visible and not alienK.visible and not alienL.visible and not alienM.visible and not alienN.visible and not alienO.visible:
			loopbreak2 = True
			loopbreak = True
